...
app.use('/api/rooms/:id', proxy({ target: 'http://172.17.0.3:8080' }))
// app.use('/rooms/:id/photos', proxy({ target: 'http://localhost:1337' }))
// app.use('/house/', proxy({ target: 'http://localhost:3123' }))
app.use('/api/reviews/rooms/:roomid', proxy({ target: 'http://172.17.0.4:3124' }))
app.use('/api/ratings/rooms/:roomid', proxy({ target: 'http://172.17.0.4:3124' }))
